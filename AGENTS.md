...
| Overlay UI, pointer/keyboard flow | `src/main.ts` | `AnnotationEditorOverlay`; refactor instead of growing when possible |
...
| `AnnotationEditorOverlay` | class | `src/main.ts` | Editor overlay UI, drawing interaction, save debounce |
